...
[![Release](https://github.com/9bingyin/Gist/actions/workflows/release.yml/badge.svg)](https://github.com/9bingyin/Gist/actions/workflows/release.yml) [![Build Docker Image](https://github.com/9bingyin/Gist/actions/workflows/docker-build.yml/badge.svg)](https://github.com/9bingyin/Gist/actions/workflows/docker-build.yml)
...
- **沉浸式阅读** -- Readability 模式提取正文
- **AI 摘要与翻译** -- 支持 OpenAI / Anthropic / 兼容接口 (自带密钥)
- **全文搜索** -- 跨所有文章快速检索
- **订阅管理** -- 文件夹分层 + 内容分类
- **深色模式** -- 浅色 / 深色 / 跟随系统
- **PWA** -- 可安装到桌面和移动设备
